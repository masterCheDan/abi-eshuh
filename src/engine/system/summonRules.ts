import type { SkillRef, SummonKind } from '../model/types'
...
const VEHICLES = new Set([30000, 30001, 30002, 30003, 30004, 30005, 36001])
const COVERS = new Set([99997, 99998, 99999])
